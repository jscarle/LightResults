...
{
    [Fact]
    public void DefaultStruct_ShouldBeFailedResultWithDefault()
    {
        // Arrange
        ...
        using (new AssertionScope())
        {
            ...
            result.IsSuccess(out var successValue).Should().BeFalse();
    ...
    [Fact]
    public void DefaultStruct_ShouldBeFailedResultWithNull()
    {
        // Arrange
