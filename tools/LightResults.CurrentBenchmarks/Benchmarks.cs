...
public class Benchmarks
{
    ...
    [Benchmark]
    public void Current_NewError_WithErrorMessage()
    {
        for (var iteration = 0; iteration < Iterations; iteration++)
    ...
    [Benchmark]
    public void Current_ResultBase_Indexer()
    {
        for (var iteration = 0; iteration < Iterations; iteration++)
    ...
    [Benchmark]
    public void Current_ResultBase_HasError()
    {
        for (var iteration = 0; iteration < Iterations; iteration++)
    ...
    [Benchmark]
    public void Current_ResultBase_Ok_ToString()
    {
        for (var iteration = 0; iteration < Iterations; iteration++)
    ...
    [Benchmark]
    public void Current_ResultBase_Fail_ToString()
    {
        for (var iteration = 0; iteration < Iterations; iteration++)
    ...
    [Benchmark]
    public void Current_ResultBase_Fail_WithErrorMessage_ToString()
    {
        for (var iteration = 0; iteration < Iterations; iteration++)
